...
/*7.Create an if statement that checks if orderHasShipped is true. 
If it is true, console log the string value "true". If not, console log the string value "false".*/
